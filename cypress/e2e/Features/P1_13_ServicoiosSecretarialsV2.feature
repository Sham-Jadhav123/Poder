Feature: ServicoiosSecretarialsV2 Flow
  ...
  Scenario:  Verify "Tribunal" Field Updates Based on Selected 
             "Distrito Judicial" Verify that when a "Distrito 
             Judicial" is selected, the "Tribunal" field displays 
             only the tribunals associated with the selected 
             "Distrito Judicial."
