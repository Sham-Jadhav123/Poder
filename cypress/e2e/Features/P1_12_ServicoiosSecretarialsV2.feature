Feature: ServicoiosSecretarialsV2 Flow
  ...
  Scenario:  Verify "Distrito Judicial," "Tribunal," and "Sala" Fields Are Prefilled When "Tribunal" Is Selected
             Verify that when "Tipo de Depositante" is selected as "Tribunal," the "Distrito Judicial," "Tribunal," 
             and "Sala" fields are prefilled.
